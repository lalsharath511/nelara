...
const Contact = () => {
    useDocTitle('Nalara Tech |Contacts  - Send us a message')
            ...
            <div className="flex justify-center items-center mt-8 w-full bg-white py-12 lg:py-24 bg-gray-200">
                ...
                {/* <form method='POST' action='https://script.google.com/macros/s/AKfycbxV0agXbNTrBmk7MHVY3bVixqW_SiZR8uksc1RvRgRnAsARFToIzmCsjZ91sWL307W_/exec'> */}
                            ...
                            <div className="flex flex-col text-white">
                                ...
                                <div className="flex my-4 w-2/3 lg:w-3/4">
                                    ...
                                    <div className="flex flex-col">
                                        ...
                                        <p className="text-gray-400">Hennur cross main road ,Banglore city,Karnataka,India</p>
                                    </div>
                                </div>
                    ...
                    <div className="flex my-4 w-2/3 lg:w-1/2">
                        ...
                        <p className="text-gray-400">Tel: +918921437118</p>
                        
                            <div className='mt-5'>
                                <h2 className="text-2xl">Send an E-mail</h2>
                                <p className="text-gray-400">nalaratech.ai@gmail.com</p>
                            </div>
                    ...
                    <div className="flex my-4 w-2/3 lg:w-1/2">
                        <a href="https://www.facebook.com/profile.php?id=61550116136449" target="_blank" rel="noreferrer" className="rounded-full flex justify-center bg-white h-8 text-blue-900  w-8 inline-block mx-1 text-center pt-1">
                        ...
                        <a href="https://www.linkedin.com/in/sharath-lal-kv-399293198/" target="_blank" rel="noreferrer" className="rounded-full flex justify-center bg-white h-8 text-blue-900  w-8 inline-block mx-1 text-center pt-1">
