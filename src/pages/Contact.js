            ...
            <div className="flex justify-center items-center mt-8 w-full bg-white py-12 lg:py-24 bg-gray-200">
                ...
                <form onSubmit={sendEmail}>
                    ...
                    <div className="flex my-4 w-2/3 lg:w-1/2">
                        ...
                        <a href="www.linkedin.com/in/sharath-lal-kv-399293198" target="_blank" rel="noreferrer" className="rounded-full flex justify-center bg-white h-8 text-blue-900  w-8 inline-block mx-1 text-center pt-1">
