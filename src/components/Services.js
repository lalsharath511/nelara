                        ...
                        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
                            ...
                            <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
                                ...
                                <img alt="card img" className="rounded-t group-hover:scale-[1.15] transition duration-1000 ease-in-out" src={img2} />
                                    <h2 className="font-semibold my-4 text-2xl text-center">Web Scraping Services</h2>
                                    <p className="text-md font-medium">
                                        We provide Data extraction from websites and online sources, Real-time data updates and monitoring, Competitor analysis and market research.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
                                ...
                                <img alt="card img" className="rounded-t group-hover:scale-[1.15] transition duration-1000 ease-in-out" src={img4} />
                                    <h2 className="font-semibold my-4 text-2xl text-center ">AI-Powered Automation Solutions</h2>
                                    <p className="text-md font-medium">
                                    Experience our IT consultation service that offers expert guidance and unwavering support to both businesses and individuals striving to optimize their technological solutions. Discover the potential of custom AI-driven process automation, achieve workflow optimization, enhance operational efficiency, and harness intelligent data analysis for informed decision-making.
                                    </p>
                                </div>
                            </div>                    
                        </div>
                    ...
                    <div className="flex flex-col-reverse lg:flex-row py-8 justify-between lg:text-left" data-aos="zoom-out">
                        <div className="lg:w-1/2 flex flex-col lg:mx-4 justify-center">
                            ...
                            <div>
                                ...
                                Drawing upon a decade of software analysis and design expertise, coupled with an in-depth grasp of the most current IT trends and solutions, we offer tailor-made recommendations and strategies. Our aim is to empower you with the means to elevate operations, curtail costs, and amplify efficiency in ways that are uniquely attuned to your enterprise.
                                </p>
                            </div>
                        </div>
                        <div className="lg:w-1/2 flex flex-col lg:mx-4 justify-center">
